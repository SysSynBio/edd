...
### Linux / Debian Setup <a name="Debian">Â¶</a>
...
### Common Setup Tasks <a name="Common">Â¶</a>
...
### For Developers <a name="Developers">Â¶</a>
...
2. __Add `--static-watch` to `command`__
...
## Running EDD <a name="#Running_EDD">Â¶</a>
