...
def study_describe_experiment(request, pk=None, slug=None):
    ...
    allow_duplicate_names = ALLOW_DUPLICATE_NAMES_PARAM in request.META['QUERY_STRING']
    ignore_ice_related_errors = IGNORE_ICE_RELATED_ERRORS_PARAM in request.META['QUERY_STRING']
